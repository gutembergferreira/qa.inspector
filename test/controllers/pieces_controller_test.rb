...
class PiecesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create piece" do
    assert_difference('Piece.count') do
      post pieces_url, params: { piece: { code: @piece.code, description: @piece.description, model: @piece.model, sketch: @piece.sketch } }
    end
  ...
  test "should update piece" do
    patch piece_url(@piece), params: { piece: { code: @piece.code, description: @piece.description, model: @piece.model, sketch: @piece.sketch } }
