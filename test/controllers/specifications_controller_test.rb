...
class SpecificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create specification" do
    assert_difference('Specification.count') do
      post specifications_url, params: { specification: { methodinspect: @specification.methodinspect, name: @specification.name } }
    end
  ...
  test "should update specification" do
    patch specification_url(@specification), params: { specification: { methodinspect: @specification.methodinspect, name: @specification.name } }
